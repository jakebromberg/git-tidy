...
pub fn discover_repos(directory: &Path) -> Result<Vec<PathBuf>, Error> {
    ...
    for entry in entries {
        ...
        // Skip bare repos: bare repos have HEAD but no .git subdir.
        // Since we already verified .git is a directory, this is a normal repo.
        // But check for bare repos that look like: <dir>/HEAD exists, <dir>/.git doesn't.
        // That case is already excluded above since we require .git to exist.
...
mod tests {
    ...
    fn discover_repos_finds_real_repo() {
        ...
        // Create a real repo (.git directory)
    ...
    fn discover_repos_skips_worktrees() {
        ...
        // Create a linked worktree (.git file, not directory)
    ...
    fn discover_repos_multiple() {
        ...
        // Also a worktree and a non-repo — should be skipped
